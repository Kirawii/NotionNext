...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kirawii', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '只要我们坦诚，而且我们善良，最后，只要我们永远不互相遗忘...', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kirawii.cyou', // 网站地址
